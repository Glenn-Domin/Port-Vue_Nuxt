<template>
  <article class="case-content container">
    <above-fold :style="'background-image: url(' + banner + ')'">
      ...
      <h2 slot="subheading" class="item-subtitle">WordPress Public-facing site.</h2>
    </above-fold>
    <section id="content" class="row content">
      ...
      <div class="content-big">
        <img src="~/static/images/cd5-op.jpg" alt="Example Home Page">
      </div>
    </section>
    <section>
      <div>
      ...
      <div class="row">
        ...
        <div class="content-small">
          <img src="~/static/images/cd6-op.jpg" alt="Example Title Standings Page">
        </div>
      </div>
    </section>
  </article>
