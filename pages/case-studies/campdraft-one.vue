  ...
  <article class="case-content container">
    ...
    <section id="content" class="row content">
      ...
      <div class="content-big">
        <img src="~/static/images/cd1-op.jpg" alt="Example 'Select Memebers To Register' page">
        <img src="~/static/images/cd3-op.jpg" alt="Example 'Create Draft' page">
      </div>
    </section>
    <section>
      <div>
      ...
      <div class="row">
        ...
        <div class="content-small">
          <img src="~/static/images/cd2-op.jpg" alt="Example Log In Page">
        </div>
      </div>
    </section>
  </article>
